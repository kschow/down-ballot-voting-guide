    ...
    'races': [
        {
            ...
            'issues': [
                ...
                },
                {
                    ...
                    'question': 'What are your recommendations to improve the immigration system?'
                },
                {
                    'issueId': 3,
                    'issueName': 'Health Care',
                    'question': 'What legislation would you support to address access to and cost of healthcare?'
                },
                {
                    'issueId': 4,
                    'issueName': 'Gun Violence',
                    'question': 'What are your recommendations to curb gun violence in our country?'
                },
                {
                    'issueId': 5,
                    'issueName': 'Other Issues',
                    'question': 'What other issues do you believe will be most pressing in the next session of Congress, and what are your positions on these issues?'
                }
            ],
            'candidates': [
                {
                    'candidateId': 8,
                    'candidateName': 'Chris Bell',
                    'party': 'democrat',
                    'positions': [
                        {
                            'issueId': 1,
                            'position': 'The only candidate in this race with experience in Congress and running statewide - Served 5 years on Houston City Council (1997–2001), chairing the Ethics Committee and Customer Service and Initiatives. - Served as US Congressman (TX-25) as a member of the Whip Team. - Earned the 2006 Democratic Nomination for Governor, coming the closest any Dem since Gov. Ann Richards'
                        },
                        {
                            'issueId': 2,
                            'position': 'Pass the DREAM Act and create a pathway to citizenship for undocumented immigrants and DREAMers. - End family separation and border detention facilities - Decriminalized unauthorized border crossings and migration. - Reform CBP and ICE in order to best protect our borders while treating immigrants with dignity and integrity'
                        },
                        {
                            'issueId': 3,
                            'position': 'Create an automatic enrollment public option, otherwise known as access to Medicare for All. - Lower prescription drug prices by making generic drugs more accessible and mandating the government to negotiate directly with pharmaceutical manufacturers. - Protect access to women’s health providers. Texas is the number one state in maternal mortality. This must end.'
                        },
                        {
                            'issueId': 4,
                            'position': 'I support universal background checks and red flag laws that 90% of Americans fully support. - I would close the Charleston and Gun Show Loopholes. - Would take a step further and support a ban on assault weapons and a mandatory buyback program that would allow citizens to give up their weapons of war, otherwise under civil penalties'
                        },
                        {
                            'issueId': 5,
                            'position': 'Reforming the Tax Cuts and Jobs Act. We must make a more equitable tax system that requires the ultra-rich to pay their fair share. - Establish a $15 minimum wage indexed to inflation. - Rejoin the Paris Climate Accord and enact measures to fight Climate Change. - Invest in Education and make college debt dischargeable.'
                        }
                    ],
                    'education': 'B.A. from the University of Texas at Austin and a J.D. from South Texas College of Law',
                    'campaignWebsite': 'http://electchrisbell.com/',
                    'facebook': 'https://facebook.com/ChrisBellForSenate/',
                    'twitter': 'http://twitter.com/BellForSenate',
                    'video': 'https://youtu.be/QEz96tdOR4g'
                },
                {
                    'candidateId': 9,
                    'candidateName': 'Amanda K. Edwards',
                    'party': 'democrat',
                    'positions': [
                        {
                            'issueId': 1,
                            'position': 'For the last four years I have represented 2.3 million Texans as a Houston City Council Member, where I spearheaded efforts on Hurricane Harvey recovery and technology & innovation, and oversaw a multi-billion dollar budget. Prior to public service I practiced as a municipal finance lawyer, and was involved in numerous non-profit activities. My focus is achieving results.'
                        },
                        {
                            'issueId': 2,
                            'position': 'Comprehensive immigration reform is long overdue. We can have a secure border, treat people with dignity and respect, keep families together and reduce the years-long backlog of those waiting to lawfully enter. Enforcement should focus on serious criminal activity like drug and human trafficking, and the US should work to stabilize nations that are sources of immigration.'
                        },
                        {
                            'issueId': 3,
                            'position': 'Health care is a life or death issue for many. We should strengthen the ACA to cover more people. The federal government should offer an affordable public option and lower costs of premiums & prescription drugs. Texas should expand Medicaid, which would cover more than 1 million uninsured residents. Those who are satisfied with their current coverage should keep it.'
                        },
                        {
                            'issueId': 4,
                            'position': 'Universal background checks and nationwide “red flag” laws are crucial first steps. Limiting the availability of high capacity weapons and and ammunition also should be considered. While mass shootings receive a great deal of attention, most gun deaths occur in less high profile ways, and a majority are suicides. A comprehensive approach must proceed with that in mind.'
                        },
                        {
                            'issueId': 5,
                            'position': 'Growing income and wealth inequality are huge concerns. With Texas being number 1 for rural hospital closures and number 1 for uninsured Americans, we much ensure that sustainable wage jobs with benefits are available in urban centers, suburbs and rural communities across America. We must also make available portable job training credits for those in manufacturing.'
                        }
                    ],
                    'education': 'B.A. Emory University, 2004 J.D. Harvard University, 2007',
                    'campaignWebsite': 'http://www.amandafortexas.com/',
                    'facebook': 'https://www.facebook.com/amandafortexas/',
                    'twitter': 'http://twitter.com/amandafortexas',
                    'video': 'https://youtu.be/PNSyB86wpPM'
                },
                {
                    'candidateId': 10,
                    'candidateName': 'Michael Cooper',
                    'party': 'democrat',
                    'positions': [
                        {
                            'issueId': 1,
                ...
                },
                {
                    ...
                    'campaignWebsite': 'http://www.votejackdaniel.com/',
                    'facebook': null,
                    'twitter': 'http://twitter.com/JackDanielFost1',
                    'video': null
                },
                {
                    'candidateId': 12,
                    'candidateName': 'Annie \'Mama\' Garcia',
                    'party': 'democrat',
                    'positions': [
                        {
                            'issueId': 1,
                            'position': 'I’m not a politician. I have built 2 small businesses and a non-profit, all profitable. Our family relies on all our paychecks to live. I speak 3 languages & have lived in 3 other countries. I am a ‘fed-up mama’ with 3 small kiddos. I’m running because we are running out of time. I have the moral clarity, political courage & work ethic to do what no politician will.'
                        },
                        {
                            'issueId': 2,
                            'position': 'This is personal. My husband is a naturalized citizen, we have Cuban family & I practice immigration law. Politicians lack the courage to fix it & now we separate families & kids die in our care. The irony is that our success is a direct product of our diversity. We must rebuild the system so we honor our values & benefit our economy.'
                        },
                        {
                            'issueId': 3,
                            'position': 'My daughter nearly died from a heart defect. We didn’t have insurance. She lived thanks to $1,500,000 in treatment. Here, we would be bankrupt, but she was born in Spain, where healthcare is a right. Americans deserve the same. Here it costs 2xs as much, doesn’t cover 1/4 of Americans & up to 400,000 patients die annually from medical error.'
                        },
                        {
                            'issueId': 4,
                            'position': 'More Americans die every WEEK from guns than most countries experience in a YEAR. This Is Not Normal. It’s a trade-off between the GOP & NRA- GOP power for gunmaker profits, paid for yearly in the blood of 40,000. We must do it all & more. Gunowners must carry gun liability insurance, like we do for cars. Let insurance companies access risk.'
                        },
                        {
                            'issueId': 5,
                            'position': 'There are so many existential threats that have been made worse by this administration, I can’t pick one. Poverty. Crappy healthcare. Domestic terrorism. Climate change. Security. Voter suppression. What I know is that we can overcome all of this, if we have the moral clarity, political courage & work ethic.'
                        }
                    ],
                    ...
                    'campaignWebsite': 'http://www.runannierun.com/',
                    'facebook': 'https://www.facebook.com/RunAnnieRun',
                    'twitter': 'http://twitter.com/RunAnnieRun2',
                    'video': 'https://youtu.be/ZnctebfrLzM'
                },
                {
                    'candidateId': 13,
                    'candidateName': 'Victor Hugo Harris',
                    'party': 'democrat',
                    'positions': [
                        {
                            'issueId': 1,
                ...
                },
                {
                    ...
                    'positions': [
                        ...
                        {
                            'issueId': 4,
                            'position': 'Every 3 hours, we lose a Texan to gun violence. I have endorsed the March for Our Lives Peace Plan and I will advocate for gun legislation that the majority of Americans support, including universal background checks, banning and buying back assault weapons like AR-15s and AK-47s, and holding the gun lobby accountable for the harm they have done to our communities.'
                        },
                        {
                            'issueId': 5,
                            'position': 'Climate Change: I support the Green New Deal because it will create millions of new jobs, and will support oil and gas workers as we transition from fossil fuels to cleaner energy sources.\nEducation: I support funding our education system from kindergarten through college, and investing in our greatest asset: our people. This means universal Pre-K and free public college.'
                        }
                    ],
                    'education': 'BA in Liberal Arts & Latin American Studies, The University of Texas at Austin',
                    'campaignWebsite': 'http://cristinafortexas.com/',
                    'facebook': 'https://www.facebook.com/TzintzunCris/',
                    'twitter': 'http://twitter.com/cristinafortx',
                    'video': null
                },
                {
                    'candidateId': 19,
                    'candidateName': 'Royce West',
                    'party': 'democrat',
                    'positions': [
                        {
                            'issueId': 1,
                            'position': 'I have been a practicing attorney for more than 40 years and I’ve owned my own practice for 25 years. I know what it takes to own and operate a business. I have also served in the Texas Senate since 1993 which gives me an unmatched depth of knowledge about the legislative process.'
                        },
                        {
                            'issueId': 2,
                        ...
                        {
                            'issueId': 3,
                            'position': 'I would support strengthening the ACA with a public option. I do not believe nationalizing insurance is the best path forward. We need competition on standard products so that people can decide for themselves. I am looking at a number of ways of removing politics from this to stop future Administrations from gutting the ACA.'
                        },
                        {
                            'issueId': 4,
                            'position': 'I am for restoring the ban on assault rifles and instituting a ban on magazines that hold more than 8 rounds. I support a national background check system that closes all loopholes, even individual sales.'
                        },
                        {
                            'issueId': 5,
                            'position': 'I believe criminal justice reform, a woman’s right to choose, equal pay for women, student debt relief, and employment non-discrimination will be key issues in the next session. I favor a multitude of criminal justice reforms, favor a woman’s right to choose, support equal pay for women, support a comprehensive student debt relief program, and will vote to pass ENDA.'
                        }
                    ],
                    'education': 'University of Texas at Arlington, BA, MA University of Houston, JD',
                    'campaignWebsite': 'http://roycewest.com/',
                    'facebook': 'https://www.facebook.com/RoyceWestTX/',
                    'twitter': 'http://twitter.com/roycewesttx',
                    'video': null
                }
            ]
        }
